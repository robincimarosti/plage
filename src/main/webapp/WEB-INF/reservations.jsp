...
<c:forEach items="${pageDeReservations.content}" var="reservation">
	<li>${reservation.client.nom} ${reservation.client.prenom} ${reservation.client.pays.nom} du ${reservation.dateDebut} au ${reservation.dateFin} <a href="reservation?ID_RESERVATION=${reservation.id}">Modifier</a></li>
</c:forEach>
</ul>

...
import fr.humanbooster.fx.plage.util.NbInscrits;
...
public interface ClientDao extends JpaRepository<Client, Long> {
	...
	@Query(value = """
			SELECT new fr.humanbooster.fx.plage.util.NbInscrits(year(c.dateHeureInscription), month(c.dateHeureInscription), COUNT(c.id))
			FROM Client c
